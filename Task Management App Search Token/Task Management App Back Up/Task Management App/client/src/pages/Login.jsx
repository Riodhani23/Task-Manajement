      ...
      <div className='w-full md:w-auto flex gap-0 md:gap-40 flex-col md:flex-row items-center justify-center'>
        ...
        <div className='h-full w-full lg:w-2/3 flex flex-col items-center justify-center'>
          <div className='w-full md:max-w-lg 2xl:max-w-3xl flex flex-col items-center justify-center gap-5 md:gap-y-10 2xl:-mt-20'>
            <span className='flex gap-1 py-1 px-3 border rounded-full text-sm md:text-base bordergray-300 text-gray-600'>
              Aplikasi Task Management PeTIK
            </span>
            ...
            <div className='cell'>
              <div className='circle rotate-in-up-left'> <img src="/public/PETIK.png" alt="Descriptive Text" style={{ width: '100%', height: 'auto' }} /></div>
            </div>
          </div>
        </div>
        ...
        <div className='w-full md:w-1/3 p-4 md:p-1 flex flex-col justify-center items-center'>
          <form onSubmit={handleSubmit(submitHandler)} className='form-container w-full md:w-[400px] flex flex-col gap-y-8 bg-white px-10 pt-14 pb-14'>
            <div className=''>
              <p className='text-green-500 text-3xl font-bold text-center'>Welcome Back!</p>
